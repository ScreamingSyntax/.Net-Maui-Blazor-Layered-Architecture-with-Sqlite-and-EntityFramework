...
3. **Build & run**
   ...
   Or open the solution in **Visual Studio / Rider** and run or debug.

The database file (`app.db`) will be **automatically created** in the local app data folder on first run.

---

## 📘 Detailed Guide

Full step-by-step walkthrough including:
- Code explanations
